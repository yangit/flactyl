...
EXPORTDIR=../../../production/case/4.2/iceberg
...
do
    ...
    # inside
    time /Applications/OpenSCAD.app/Contents/MacOS/OpenSCAD -DPARTNO=\"left\" -o $EXPORTDIR/variant$i/case1.png --imgsize=1600,1200 --camera=40,60,20,70,0,40,400 iceberg$i.scad
    # inside with keys
    time /Applications/OpenSCAD.app/Contents/MacOS/OpenSCAD -DPARTNO=\"left\"\;KEYS=true -o $EXPORTDIR/variant$i/case2.png --imgsize=1600,1200 --camera=40,60,20,70,0,40,400 iceberg$i.scad
    # outside
    time /Applications/OpenSCAD.app/Contents/MacOS/OpenSCAD -DPARTNO=\"left\" -o $EXPORTDIR/variant$i/case3.png --imgsize=1600,1200 --camera=80,60,20,70,0,-40,400 iceberg$i.scad
    # outside with keys
    time /Applications/OpenSCAD.app/Contents/MacOS/OpenSCAD -DPARTNO=\"left\"\;KEYS=true -o $EXPORTDIR/variant$i/case4.png --imgsize=1600,1200 --camera=80,60,20,70,0,-40,400 iceberg$i.scad
