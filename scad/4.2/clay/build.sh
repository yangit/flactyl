...
EXPORTDIR=../../../production/case/4.2/clay
...
# inside
time /Applications/OpenSCAD.app/Contents/MacOS/OpenSCAD -DPARTNO=\"left\" -o $EXPORTDIR/case1.png --imgsize=800,600 --camera=40,70,0,70,0,50,400 clay.scad
# inside with keys
