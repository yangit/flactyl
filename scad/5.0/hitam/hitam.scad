...
//                         anchor_pcb() push(-caseThikness) offset(caseThikness + wallOffsetFromPcb)
//                         left_pcb_with_keys_dxf();
...
//             // reset button access
//             rotate([ 0, 90 - tentingAngle, 0 ]) translate([ -0.001, ccBackWall, 48 ]) cube([ caseThikness * 3, 10,
//             100 ]);
...
// anchor_thumb() translate([ 0, 0, keysThikness + pcbAndHotswapThikness]) rotate([ 0, -90, 0 ]) push(cutter,5)
...
//     // anchor_pcb() color(keysColor) translate([ 0, 0, pcbAndHotswapThikness ]) push(keysThikness)
//     left_keycaps_dxf();
